...
pam_result <- plot(pam(gower_df, k=2, diss=TRUE), main = "Silhouetter Chart with 2 clusters", xlab = "", sub = "", cex = .9)
```

```{r}
plot(pam(gower_df, k=2, diss=TRUE), main = "Silhouetter Chart with 2 clusters",
xlab = "", sub = "", cex = .9)
```
